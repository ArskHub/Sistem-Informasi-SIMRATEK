...
// Route::get('/dashboard/users/export', [DashboardUserController::class, 'exportPDF'])->name('pdfUser');

Route::get('/exportuser', [DashboardUserController::class, 'exportuser'])->name('pdfUser');

Route::get('/exportroom', [DashboardRoomController::class, 'exportroom'])->name('pdfRoom');

Route::get('/exportrent', [DashboardRentController::class, 'exportrent'])->name('pdfRent');
