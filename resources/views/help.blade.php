    ...
    <div class="hero hero-bantuan">
      ...
      <div class="how-use-simanuk my-4 container">
          ...
          <div class="list-tahapan p-5">
              <ul>
                  <li>Untuk melakukan peminjaman, Anda diharuskan melakukan login terlebih dahulu sesuai dengan username yang telah disediakan oleh admin pada saat sosialisasi SIMRATEK.</li>
